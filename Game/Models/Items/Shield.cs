...
namespace Game.Models.Items
{
    public class Shield : Item
    {
        ...
        private const string PathImage = "../../Resources/hylian_shield.png";
        
        public Shield(string id, Point location, Size objectSize)
            : base(id, location, objectSize, shieldAttackEffect, shieldDefenceEffect, shieldHealthEffect,PathImage)
        {
        }
    }
}